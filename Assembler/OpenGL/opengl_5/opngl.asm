...
Position1 dd -1.0,1.0,-5.0
Position2 dd 1.0,-1.0,-7.0
...
invoke SolidCylinder,1,ADDR orange,ADDR CylinderRadius1,24
invoke WireCylinder,2,ADDR green,ADDR CylinderRadius2,12
invoke glMatrixMode,GL_PROJECTION
ret
CreateObjects		ENDP
; #########################################################################
...
rotate 2,ADDR Position2,ADDR RotSpeed,ADDR RotAngles
